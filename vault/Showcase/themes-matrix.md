...
```mermaid
graph TD
    Start[创作者原稿文库] --> Q1{追求零环境依赖与极客美学?}
    Q1 -- 是 --> Sovereign[👑 Sovereign 旗舰 / 🏛️ Universal 标准]
    Q1 -- 否 --> Q2{主要用途类型?}
    
    Q2 -- 技术团队文档 / API 手册 --> Q3{前端技术栈偏好?}
    Q3 -- React / MDX --> Docusaurus[🦖 Docusaurus / 📖 Nextra]
    Q3 -- Vue 3 / Vite --> VitePress[⚡ VitePress]
    Q3 -- Astro 零 JS --> Starlight[🌟 Astro Starlight]
    
    Q2 -- 经典博文归档 / 海量文章 --> Q4{文章规模?}
    Q4 -- < 1,000 篇 --> Hexo[🎨 Hexo Clean Tech]
    Q4 -- > 10,000 篇超大海量 --> Hugo[🐹 Hugo Go-Speed Engine]
```
