...
(function () {
        ...
        try {
            ...
            if (res.is_licensed && rawTier !== 'LITE' && rawTier) {
                if (rawTier === 'STANDARD' || rawTier === 'PLUS' || rawTier === 'STD') {
                    ...
                    if (pillsEl) pillsEl.innerHTML = `<span class="lic-pill-unlocked">✓ 工业级 AI 出版引擎</span><span class="lic-pill-unlocked">✓ Obsidian 双链全息图谱</span><span class="lic-pill-unlocked">✓ 创作中心灵感润色</span><span class="lic-pill-unlocked">✓ 5个独立品牌管理</span><span class="lic-pill-unlocked">✓ 5个目标语种翻译</span><span class="lic-pill-unlocked">✓ 📂 子目录精准收稿</span><span class="lic-pill-locked">🔒 99 个独立品牌 (专业版)</span><span class="lic-pill-locked">🔒 全量语种矩阵 (专业版)</span>`;
                    ...
                    if (descEl) descEl.innerHTML = `<div>🚀 已解锁高级专业版全量特权！支持 99 个独立品牌与全量语种矩阵任选。</div><div style="margin-top: 6px; font-weight: 600; color: var(--accent-primary, #00f2fe); font-size: 0.78rem;">🔑 授权客户：${res.customer} <span style="opacity: 0.85; font-weight: normal;">(至 ${res.exp_date})</span></div>`;
                    if (pillsEl) pillsEl.innerHTML = `<span class="lic-pill-unlocked">✓ 工业级 AI 出版引擎</span><span class="lic-pill-unlocked">✓ Obsidian 双链全息图谱</span><span class="lic-pill-unlocked">✓ 创作中心灵感润色</span><span class="lic-pill-unlocked">✓ 算力节点灵活对接</span><span class="lic-pill-unlocked">✓ 99个独立品牌管理</span><span class="lic-pill-unlocked">✓ 全量语种矩阵任选</span><span class="lic-pill-unlocked">✓ 📂 子目录精准收稿</span><span class="lic-pill-unlocked">✓ 全量装帧主题自由切换</span>`;
                    if (revokeBtn) revokeBtn.style.display = 'inline-block';
                }
            } else {
    ...
    // 💎 [许可证交互解耦] 许可证激活、注销解绑与机器指纹复制已抽离至 license/license.actions.js 供给
})();
