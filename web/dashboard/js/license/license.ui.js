        ...
        try {
            ...
            if (res.is_licensed) {
                ...
                if (tier === 'STANDARD') {
                    ...
                    if (descEl) descEl.innerHTML = `<div>🚀 已解锁基础增强版特权！支持 3 个出版版图、3~5 个主流语种矩阵与子目录频道精准映射。</div><div style="margin-top: 6px; font-weight: 600; color: var(--accent-primary, #00f2fe); font-size: 0.78rem;">🔑 授权客户：${res.customer} <span style="opacity: 0.85; font-weight: normal;">(至 ${res.exp_date})</span></div>`;
                    if (pillsEl) pillsEl.innerHTML = `<span class="lic-pill-unlocked">✓ 工业级 AI 出版引擎</span><span class="lic-pill-unlocked">✓ Obsidian 双链全息图谱</span><span class="lic-pill-unlocked">✓ 创作中心灵感润色</span><span class="lic-pill-unlocked">✓ 3个独立版图管理</span><span class="lic-pill-unlocked">✓ 3~5个主流语种翻译</span><span class="lic-pill-unlocked">✓ 📂 子目录频道映射</span><span class="lic-pill-unlocked">✓ ⚡ 双节点主备容灾</span><span class="lic-pill-locked">🔒 ♾️ 无限版图 (专业版)</span><span class="lic-pill-locked">🔒 🌐 50+语种矩阵 (专业版)</span><span class="lic-pill-locked">🔒 🎭 频道方言风格 (专业版)</span>`;
                    ...
                    if (descEl) descEl.innerHTML = `<div>🚀 已解锁高级专业版全量特权！支持无限版图隔离、50+ 语种多线程翻译矩阵与混合算力集群。</div><div style="margin-top: 6px; font-weight: 600; color: var(--accent-primary, #00f2fe); font-size: 0.78rem;">🔑 授权客户：${res.customer} <span style="opacity: 0.85; font-weight: normal;">(至 ${res.exp_date})</span></div>`;
                ...
                if (descEl) descEl.innerHTML = '✨ 免费社区版已包含完整 AI 创作润色、Obsidian 双链全息图谱与全自动静态出版引擎。激活增强版或专业版可进一步解封多版图管理、多语种并行矩阵分发与子目录频道映射。';
                if (pillsEl) pillsEl.innerHTML = `<span class="lic-pill-unlocked">✓ 工业级 AI 出版引擎</span><span class="lic-pill-unlocked">✓ Obsidian 双链全息图谱</span><span class="lic-pill-unlocked">✓ 创作中心灵感润色</span><span class="lic-pill-unlocked">✓ 算力节点灵活对接</span><span class="lic-pill-unlocked">✓ 单品牌全渠道分发</span><span class="lic-pill-locked">🔒 3个独立版图 (增强版)</span><span class="lic-pill-locked">🔒 多语种矩阵分发 (增强版)</span><span class="lic-pill-locked">🔒 子目录频道映射 (增强版)</span><span class="lic-pill-locked">🔒 频道专属方言风格 (专业版)</span><span class="lic-pill-locked">🔒 算力集群自动容灾 (专业版)</span>`;
