...
window.PLATFORM_PORTAL_LINKS = {
    ...
    'cloudflare_r2': { name: 'Cloudflare R2', home: 'https://dash.cloudflare.com', token: 'https://dash.cloudflare.com/?to=/:account/r2' },
    'imgbb': { name: 'ImgBB', home: 'https://imgbb.com', token: 'https://api.imgbb.com' },
    'catbox': { name: 'Catbox', home: 'https://catbox.moe', token: 'https://catbox.moe/user/manage.php' },
    'telegraph': { name: 'Telegraph 自建图床', home: 'https://github.com/cf-pages/Telegraph-Image', token: 'https://github.com/cf-pages/Telegraph-Image' },
    ...
    'juejin': { name: '稀土掘金', home: 'https://juejin.cn', token: 'https://juejin.cn/creator' },
