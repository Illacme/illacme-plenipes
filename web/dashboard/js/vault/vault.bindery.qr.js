...
(function() {
    ...
    window.openBinderyQrModal = async function(filename) {
        ...
        try {
            ...
            contentEl.innerHTML = `
                <div style="background:#ffffff; border-radius:12px; padding:12px; display:inline-block; box-shadow:0 6px 20px rgba(0,0,0,0.3); margin-bottom:14px;">
                    <img src="${data.qr_data_uri}" alt="扫码下载" style="width:200px; height:200px; display:block;" />
                </div>
