...
(function() {
    ...
    function renderQrView(data, mode, status = null) {
        ...
        const badge = mode === 'public'
            ? `<div style="display:inline-flex; align-items:center; gap:6px; background:rgba(139,92,246,0.15); border:1px solid rgba(139,92,246,0.35); border-radius:12px; padding:3px 10px; font-size:0.7rem; color:#8b5cf6; margin-bottom:6px; font-weight:600; white-space:nowrap;"><span>⚡ ${esc(providerName)}</span><span>·</span><span>⏳ 30分钟有效</span></div>`
            : `<div style="display:inline-flex; align-items:center; gap:6px; background:rgba(16,185,129,0.12); border:1px solid rgba(16,185,129,0.3); border-radius:12px; padding:3px 10px; font-size:0.7rem; color:#10b981; margin-bottom:6px; font-weight:600; white-space:nowrap;"><span>📶 局域网直连 (${esc(data.lan_ip)})</span></div>`;
        ...
        const modeSelector = isWb
            ? `<div style="display:inline-flex; align-items:center; gap:4px; background:rgba(16,185,129,0.1); border:1px solid rgba(16,185,129,0.25); border-radius:8px; padding:3px 10px; font-size:0.72rem; color:var(--accent, #10b981); font-weight:600; margin-bottom:8px; white-space:nowrap;"><span>🌐 WebBook 阅读</span></div>`
            : `<div style="display:inline-flex; background:rgba(0,0,0,0.06); border:1px solid rgba(255,255,255,0.1); border-radius:8px; padding:2px; margin-bottom:8px; white-space:nowrap;"><button type="button" onclick="window.switchBinderyQrAction('view')" style="border:none; background:${isView ? 'var(--accent, #10b981)' : 'transparent'}; color:${isView ? '#fff' : 'inherit'}; padding:3px 10px; font-size:0.72rem; font-weight:600; border-radius:6px; cursor:pointer; white-space:nowrap;">👁️ 阅读</button><button type="button" onclick="window.switchBinderyQrAction('download')" style="border:none; background:${!isView ? 'var(--accent, #10b981)' : 'transparent'}; color:${!isView ? '#fff' : 'inherit'}; padding:3px 10px; font-size:0.72rem; font-weight:600; border-radius:6px; cursor:pointer; white-space:nowrap;">⬇️ 下载</button></div>`;
        contentEl.innerHTML = `
            <div style="text-align:center;">
                <div style="display:flex; justify-content:center; align-items:center; gap:8px; margin-bottom:6px; flex-wrap:wrap;">${badge}${modeSelector}</div>
