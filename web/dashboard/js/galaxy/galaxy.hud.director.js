...
window.injectGalaxyDirectorDOM = () => {
    ...
    if (!document.getElementById('galaxy-node-director')) {
        ...
        dirDiv.style.cssText = 'display: none; flex-direction: column; border-radius: 16px; padding: 20px; max-height: calc(100vh - 180px); overflow-y: auto; width: 100%; box-sizing: border-box; margin-top: 0;';
        dirDiv.innerHTML = `
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; border-bottom: 1px solid var(--glass-border); padding-bottom: 8px;"><span style="font-size: 0.7rem; font-weight: 900; color: var(--accent-secondary);">🪐 星球控制仪</span><button onclick="window.closeNodeDirector()" style="background: none; border: none; color: var(--text-dim); font-size: 1.2rem; cursor: pointer; line-height: 1; outline: none;">×</button></div>
            <div style="display: flex; flex-direction: column; gap: 12px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 6px; border-top: 1px solid var(--glass-border); padding-top: 10px;"><button class="primary-btn glow-btn" id="node-dir-btn-edit" style="width: 100%; height: 26px; font-size: 0.7rem; padding: 0;">✍️ 编辑原稿</button><button class="primary-btn glow-btn" id="node-dir-btn-publish" style="width: 100%; height: 26px; font-size: 0.7rem; background: var(--neon-cyan-05); border-color: var(--neon-cyan-15); padding: 0;">🚀 单篇发布</button><button class="primary-btn glow-btn" id="node-dir-btn-rebuild" style="width: 100%; height: 26px; font-size: 0.7rem; background: var(--accent-primary-05); border-color: var(--accent-primary-10); padding: 0;">🧠 语义重构</button><button class="primary-btn glow-btn" id="node-dir-btn-link" style="width: 100%; height: 26px; font-size: 0.7rem; background: var(--neon-cyan-05); border-color: var(--neon-cyan-15); padding: 0;">🔗 建立新关联</button></div>
            </div>
        `;
