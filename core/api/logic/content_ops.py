# -*- coding: utf-8 -*-
"""
📝 Illacme API Logic - Content Operations (内容管理业务逻辑)
职责：承载原 content.py 中的全部 CRUD 文件系统逻辑、路径防跨防御、
3D 星系图混合算法和 Obsidian 资源定位算法，向路由暴露简洁的 Python API。
🚀 [V10.2] SOP-02 DECOUPLED BUSINESS LOGIC
"""
