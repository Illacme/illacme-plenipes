...
discover_and_register(__path__, __name__, BasePublisher, PublisherRegistry.register_class)
...
if os.path.exists(global_pub_path):
    ...
    discover_and_register([global_pub_path], "adapters.egress.publishers", BasePublisher, PublisherRegistry.register_class)
