...
from core.logic.ai.ai_scheduler_shards.batch_models import BatchItem, TranslationBatch
from core.logic.ai.ai_scheduler_shards.batch_splitter import (
    split_oversized_text as _split_oversized_text,
    estimate_batch_tokens as _estimate_batch_tokens
)

# 兼容模块级直接导出
split_oversized_text = _split_oversized_text
estimate_batch_tokens = _estimate_batch_tokens
...
class BatchChunker:
    ...
    def split_oversized_text(cls, text: str, max_chars: int) -> List[str]:
        ...
        return _split_oversized_text(text, max_chars)
    ...
    def estimate_batch_tokens(
        ...
        return _estimate_batch_tokens(tasks, source_lang, target_langs_count)
